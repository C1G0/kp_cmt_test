            ...
            <span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page-teknisi" href="index.php">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?page-teknisi=absen">Absen</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?page-teknisi=riwayat">Riwayat Absensi</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?page-teknisi=logout">Logout</a>
                        </li>
                    </ul>
                </div>
        </div>
